...
// This file is part of the Censusreport block for Moodle - http://moodle.org/
//
 ...
 */
class block_censusreport_admin_setting_upload extends admin_setting_configtext {
    ...
    public function output_html($data, $query='') {
        ...
        return format_admin_setting($this, $this->visiblename,
                html_writer::link(new moodle_url('/blocks/censusreport/upload_image.php'), get_string('upload')),
